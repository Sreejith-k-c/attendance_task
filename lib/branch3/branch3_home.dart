...
class BranchThreeHome extends StatefulWidget {
  @override
  State<BranchThreeHome> createState() => _BranchThreeHomeState();
}

class _BranchThreeHomeState extends State<BranchThreeHome> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Branch 3 Home',style: TextStyle(fontWeight: FontWeight.bold)),
        centerTitle: true,
      ),
     body: Padding(
