...
class BranchTwoHome extends StatefulWidget {
  @override
  State<BranchTwoHome> createState() => _BranchTwoHomeState();
}

class _BranchTwoHomeState extends State<BranchTwoHome> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Branch 2 Home',style: TextStyle(fontWeight: FontWeight.bold)),
        centerTitle: true,
      ),
      body: Padding(
